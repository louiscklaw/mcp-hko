...
server.addTool({
    name: "hlt",
    description: "Times and Heights of Astronomical High and Low Tides (HLT) API Request",
    parameters: z.object({
        station: z.string(),
        year: z.number(),
        month: z.number().optional(),
...
server.addTool({
    name: "lhl",
    description: "Cloud-to-Ground and Cloud-to-Cloud Lightning Count (LHL) API Request",
    parameters: z.object({
        lang: z.string().default("en"),
        rformat: z.string().default("csv"),
    }),
